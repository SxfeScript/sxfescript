...
const independentA=enc.encode("same"), independentB=enc.encode("same");
independentA[0]=0;
p("independent mutable results",[independentA[0],independentB[0],independentA.buffer!==independentB.buffer]);
