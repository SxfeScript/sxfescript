...
|---|---|---|---|---|
| Real-world end-to-end task | **8.3 ms** | 76.0 ms | 16.3 ms | sxn |
| Cold start | **8.1 ms** | 43.5 ms | 9.6 ms | sxn |
| Sustained throughput: Buffer ops | **19.3 ms** | 24.3 ms | 27.5 ms | sxn |
| Sustained throughput: TextEncoder | **4.6 ms** | 39.7 ms | 6.3 ms | sxn |
| Sustained throughput: EventEmitter | 6.6 ms | **5.3 ms** | 9.3 ms | Node |
| Sustained throughput: JSON round trip | 47.2 ms | 29.6 ms | **25.3 ms** | Bun |
| Pause consistency: total time | **151.1 ms** | 246.1 ms | 284.6 ms | sxn |
| Pause consistency: worst single pause | **0.04 ms** | 0.22 ms | 2.55 ms | sxn |
| Parse 32k-line generated file | **21.3 ms** | 54.2 ms | 26.0 ms | sxn |
...
| Category | sxn | Node | Bun | Winner |
|---|---|---|---|---|
| Real-world end-to-end task | **7.2 ms** | 56.0 ms | 22.1 ms | sxn |
| Cold start | **7.3 ms** | 22.6 ms | 13.0 ms | sxn |
| Sustained throughput: Buffer ops | **37.7 ms** | 39.0 ms | 83.1 ms | sxn |
| Sustained throughput: TextEncoder | **8.3 ms** | 80.6 ms | 17.9 ms | sxn |
| Sustained throughput: EventEmitter | 14.7 ms | **10.1 ms** | 25.1 ms | Node |
| Sustained throughput: JSON round trip | 85.9 ms | 85.8 ms | **60.6 ms** | Bun |
| Pause consistency: total time | **2838.0 ms** | 3257.7 ms | 3263.9 ms | sxn |
| Pause consistency: worst single pause | **0.07 ms** | 1.76 ms | 6.02 ms | sxn |
| Parse 32k-line generated file | **35.5 ms** | 51.7 ms | 54.3 ms | sxn |
...
than behind, and JSON is a dead heat with it -- 85.9 against 85.8, with Bun
30% ahead of the pair. Parse splits three ways on both machines: sxn is 18%
faster than the runner-up on the Mac and 31% faster here.
